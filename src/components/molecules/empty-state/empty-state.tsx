export default function EmptyState({
  ...
  message = "You haven't added any data yet.",
}: {
  title?: string;
  message?: string;
}) {
  return (
    <div className="flex flex-col items-center justify-center h-[28rem] text-center border border-dashed rounded-2xl p-8 bg-white shadow-sm">
      <svg
        width="800px"
        height="800px"
