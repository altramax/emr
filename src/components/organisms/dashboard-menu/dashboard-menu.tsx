...
export default function DashboardMenu() {
  ...
  const tabs = [
    ...
    { name: 'Add Diagnosis', path: '/add-diagnosis', icon: <Stethoscope size={18} /> },
  ...
  return (
    ...
    >
      <div className="">
        <div className="flex gap-2 items-center mt-2 mb-6 w-[20px]">
          {/* <Logo /> */}
          <h1 className="text-lg font-bold truncate">LiLy HealthCare</h1>
          <Button
            value={
              <>
